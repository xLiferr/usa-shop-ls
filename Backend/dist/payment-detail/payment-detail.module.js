...
const payment_detail_controller_1 = require("./controllers/payment-detail.controller");
...
PaymentDetailModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([payment_detail_entity_1.Payment_detail])
        ],
